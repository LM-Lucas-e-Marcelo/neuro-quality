      ...
      <Reveal>
        <div className="max-w-6xl mx-auto px-6 text-center">
          <div className="mx-auto max-w-2xl text-center">
            <span className="rounded-full bg-secondary px-3 py-1 text-xs font-medium text-secondary-foreground">Diferenciais</span>
            <h2 className="mt-3 text-3xl font-bold tracking-tight md:text-4xl">Nossos diferenciais</h2>
          </div>

          <div className="mt-12 flex flex-wrap gap-8 justify-center">
            {trustOtpions.map((value, index) => (
              <div
                key={index}
